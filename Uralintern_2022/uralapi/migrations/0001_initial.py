# Generated by Django 3.2.8 on 2023-07-13 06:01
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('id_event', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='uralapi.eventuts', verbose_name='Название мероприятия')),
            ],
            options={
                'verbose_name': 'Проект',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('id_project', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='uralapi.project', verbose_name='Название проекта')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('evaluation_criteria', models.ManyToManyField(blank=True, to='uralapi.EvaluationCriteria', verbose_name='Критерии оценки')),
                ('id_team', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='uralapi.team', verbose_name='Название команды')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('id_intern', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to=settings.AUTH_USER_MODEL, verbose_name='Стажёр')),
                ('id_team', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='uralapi.team', verbose_name='Команда')),
