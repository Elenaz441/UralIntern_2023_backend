...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ('uralapi', '0002_auto_20230703_1614'),
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('name', models.CharField(choices=[('IN WORK', 'В РАБОТУ'), ('IN PROGRESS', 'ВЫПОЛНЯЕТСЯ'), ('TESTING', 'ТЕСТИРОВАНИЕ'), ('CHECKING', 'ПРОВЕРКА'), ('COMPLETED', 'ЗАВЕРШЕНА')], max_length=30, unique=True, verbose_name='Название статуса')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('time_spent', models.TimeField(blank=True, null=True, verbose_name='Время выполнения задачи')),
